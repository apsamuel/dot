...
| `curl`    | Brew installer, `dot::node::get`, fzf, secrets fetch                                                       | macOS ships `curl`                                       |
...
| `tmux`    | [`check_omtmux`](../../scripts/dot-bootstrap.sh) provisions plugin git submodules (no TPM)                 | `brew install tmux`                                      |
...
| `curl`    | [`bin/brew-bootstrap.sh`](../../bin/brew-bootstrap.sh), [`modules/001-d-node.sh`](../../modules/001-d-node.sh) `dot::node::get`, secret loaders                                                                             | Cannot install Homebrew or fetch tarballs |
...
| `yq`      | [`zshrc`](../../zshrc), [`modules/001-d-python.sh`](../../modules/001-d-python.sh), [`modules/001-d-node.sh`](../../modules/001-d-node.sh), [`modules/000-a-output.sh`](../../modules/000-a-output.sh) `dot::output::quote` | Theme + plugin list cannot be resolved    |
| `brew`    | [`modules/000-a-homebrew.sh`](../../modules/000-a-homebrew.sh) `eval shellenv`, every `brew*` helper                                                                                                                        | Tier 1+ installs unavailable              |
| `tmux`    | [`check_omtmux`](../../scripts/dot-bootstrap.sh), [`modules/001-a-tmux.sh`](../../modules/001-a-tmux.sh)                                                                                                                    | Plugin submodules are not checked out     |
...
| `rustup` + `cargo` | [`modules/001-d-rust.sh`](../../modules/001-d-rust.sh), [`bin/rust-project-format.sh`](../../bin/rust-project-format.sh) | Formatting/testing Rust sources (`test/`)                                      | `brew install rustup-init && rustup-init`                          |
...
| `figlet`     | [`modules/000-a-output.sh`](../../modules/000-a-output.sh) `dot::output::term-quote`, splash screens                     | Falls back to plain `randomQuote \| lolcat`   | `brew install figlet`                              |
| `lolcat`     | [`modules/000-a-output.sh`](../../modules/000-a-output.sh) (quote pipe)                                                  | Plain quote output                            | `brew install lolcat`                              |
| `jp2a`       | [`modules/000-a-output.sh`](../../modules/000-a-output.sh) `dot::output::logo`                                           | iCloud splash images cannot render            | `brew install jp2a`                                |
| `kitty`      | [`modules/000-a-output.sh`](../../modules/000-a-output.sh) `dot::output::image`                                          | `dot::output::image` errors out with a hint   | `brew install --cask kitty`                        |
| `shuf`       | [`modules/000-a-output.sh`](../../modules/000-a-output.sh) `dot::output::logo`/`dot::output::quote`                      | Splash + quote selection breaks               | `brew install coreutils` (provides `gshuf`/`shuf`) |
...
| [`vendor/oh-my-tmux`](../../vendor/oh-my-tmux)                                                                                         | `tmux` ≥ 3.x; `git` for plugin submodules                                                                 | `TMUX_PLUGIN_MANAGER_PATH=$DOT_ROOT/vendor/oh-my-tmux/plugins`                                  |
...
| [`vendor/figlet-fonts`](../../vendor/figlet-fonts)                                                                                     | `figlet`, `lolcat`                                                                                        | Used by `dot::output::term-quote`                                                               |
...
### 🪟 oh-my-tmux plugins — git submodules under `vendor/oh-my-tmux/plugins/` (see `.gitmodules`)
