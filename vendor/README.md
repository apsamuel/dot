...
| `tmux/` | [apsamuel/.tmux](https://github.com/apsamuel/.tmux) (fork of [gpakosz/.tmux](https://github.com/gpakosz/.tmux)) | Oh My Tmux configuration — opinionated tmux base config with a status bar and keybinding improvements. |

---

> All four projects are vendored rather than dynamically installed so that a fresh bootstrap produces an identical environment regardless of network availability or upstream changes.
