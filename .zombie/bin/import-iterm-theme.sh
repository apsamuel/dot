...
for filename in "$@"; do
	...
	#echo /usr/libexec/PlistBuddy -c 'Add "Custom Color Presets:'"$name"'" dict' -c 'Merge '"$filename"' "Custom Color Presets:'"$name"'"' "$HOME/Library/Preferences/com.googlecode.iterm2.plist"
	# delete, add, merge
	/usr/libexec/PlistBuddy -c 'Delete "Custom Color Presets:'"$name"'"' -c 'Add "Custom Color Presets:'"$name"'" dict' -c 'Merge '"$filename"' "Custom Color Presets:'"$name"'"' "$HOME/Library/Preferences/com.googlecode.iterm2.plist"
		# disable
		# echo_and_eval "/usr/libexec/PlistBuddy \\
		...
		# 		-c 'Merge \"$filename\" \"Custom Color Presets:$name\"' \\
		# 		\"\$HOME/Library/Preferences/com.googlecode.iterm2.plist\""
		#echo /usr/libexec/PlistBuddy -c 'Add "Custom Color Presets:Synthwave" dict' -c 'Merge "/Users/aaronsamuel/Library/Mobile Documents/com~apple~CloudDocs/dot/terminal/themes/iTerm2-Color-Schemes/schemes/synthwave.itermcolors" "Custom Color Presets:Synthwave"' "$HOME/Library/Preferences/com.googlecode.iterm2.plist"

		/usr/libexec/PlistBuddy -c 'Add "Custom Color Presets:'"$name"'" dict' -c 'Merge '"$filename"' "Custom Color Presets:'"$name"'"' "$HOME/Library/Preferences/com.googlecode.iterm2.plist"
	fi
done
