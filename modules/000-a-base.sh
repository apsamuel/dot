...
# INFO: tmux plugins are managed purely as git submodules inside vendor/oh-my-tmux/plugins/
#       (no tpm); they are loaded at startup by vendor/oh-my-tmux/lib/tmux-helpers.sh.
