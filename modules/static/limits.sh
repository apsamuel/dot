...
# this is a static file, we need to read the DOT_DIRECTORY and DOT_MODULES variables from environment

export DOT_DIRECTORY="${DOT_DIRECTORY:-$(dirname "$0")}"
export DOT_MODULES="${DOT_MODULES:-$(basename "$0")}"
...
export DOT_DIRECTORY DOT_MODULES
