...
help: ## Show this help
	...
	@printf "  \033[36mmake check omtmux\033[0m             verify oh-my-tmux config + plugin submodules\n"
	@echo ""
	...
	@printf "  \033[36mmake config tmux\033[0m              configure oh-my-tmux + plugin submodules\n"
...
check: ## Dispatch: make check <command>
	...
	case "$$subcmd" in
		...
		"")
			...
			echo "  omtmux     verify oh-my-tmux config + plugin submodules"
			exit 1 ;;
		*)
...
config: ## Dispatch: make config <command>
	...
	case "$$subcmd" in
		...
		"")
			...
			echo "  tmux       configure oh-my-tmux + plugin submodules"
