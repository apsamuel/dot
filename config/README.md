...
```text
data/zsh.yaml  ──►  scripts/dot-deploy-config.sh  ──►  $ICLOUD/dot/shell/zsh/zsh.yaml
       │                                                       │
...
| Script                                                      | Action                                                                        |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 🌥 [`scripts/dot-deploy-config.sh`](../scripts/dot-deploy-config.sh) | Pushes [`data/zsh.yaml`](../data/zsh.yaml) → `$ICLOUD/dot/shell/zsh/zsh.yaml` |
| 🌥 [`scripts/dot-deploy-rc.sh`](../scripts/dot-deploy-rc.sh)         | Pushes the repo's [`zshrc`](../zshrc) → `$ICLOUD/dot/shell/zsh/rc`            |
...
The submodule remains on disk under `vendor/oh-my-zsh/custom/plugins/`; only its activation by `scripts/dot-bootstrap.sh` / oh-my-zsh changes.
